...
describe(`Inserts [config] DOM Element or Object Element configuration into
    ...
    () => {
        ...
        it(`9. Should append resolved [config] DOM Node in 
        ...
        it(`10. Should not accept non-DOM Element or Document Fragment
        ...
        it(`11. Should not accept DOM document or non-Object 
        ...
        it(`12. Should not accept DOM Node [before] that is not a child of 
