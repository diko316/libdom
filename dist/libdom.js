(function webpackUniversalModuleDefinition(root, factory) {
    if (typeof exports === "object" && typeof module === "object") module.exports = factory(require(undefined)); else if (typeof define === "function" && define.amd) define("libdom", [], factory); else if (typeof exports === "object") exports["libdom"] = factory(require(undefined)); else root["libdom"] = factory(root[undefined]);
    ...
    return function(modules) {
        ...
        (function(global) {
            "use strict";
            var CORE = __webpack_require__(2), detect = __webpack_require__(3), rehash = CORE.rehash, EXPORTS = {
                env: CORE.env,
                info: detect
            };
            var css, event, dimension, selection;
            if (detect) {
                rehash(EXPORTS, __webpack_require__(10), {
                    xmlEncode: "xmlEncode",
                    xmlDecode: "xmlDecode"
                });
                rehash(EXPORTS, __webpack_require__(11), {
                    is: "is",
                    isView: "isView",
                    contains: "contains",
                    select: "select",
                ...
                rehash(EXPORTS, css = __webpack_require__(13), {
                    addClass: "add",
                    removeClass: "remove",
                    computedStyle: "computedStyle",
                    stylize: "style"
                });
                rehash(EXPORTS, event = __webpack_require__(12), {
                    on: "on",
                    un: "un",
                    purge: "purge",
                    dispatch: "fire",
                ...
                rehash(EXPORTS, dimension = __webpack_require__(21), {
                    offset: "offset",
                    size: "size",
                    box: "box",
                    scroll: "scroll",
                ...
                rehash(EXPORTS, selection = __webpack_require__(22), {
                    highlight: "select",
                    noHighlight: "unselectable",
                    clearHighlight: "clear"
                });
                rehash(EXPORTS, __webpack_require__(14), {
                    parseColor: "parse",
        ...
        "use strict";
        var browser = __webpack_require__(4), EXPORTS = false;
        if (browser) {
            EXPORTS = {
                browser: browser,
                ...
                dimension: __webpack_require__(8),
        ...
        (function(global) {
            "use strict";
            var DETECTED = __webpack_require__(4), WINDOW = global.window, ieVersion = DETECTED.ieVersion;
            module.exports = {
        ...
        "use strict";
        var CORE = __webpack_require__(2), DETECTED = __webpack_require__(3), EVENT = __webpack_require__(12), STRING = __webpack_require__(10), ORDER_TYPE_PREORDER = 1, ORDER_TYPE_POSTORDER = 2, ORDER_TYPE_LEVELORDER = 3, ERROR_INVALID_DOM = STRING[1101], ERROR_INVALID_DOM_NODE = STRING[1103], ERROR_INVALID_CSS_SELECTOR = STRING[1111], ERROR_INVALID_CALLBACK = STRING[1112], ERROR_INVALID_ELEMENT_CONFIG = STRING[1121], INVALID_DESCENDANT_NODE_TYPES = {
            9: 1,
            11: 1
        ...
        (function(global) {
            "use strict";
            var CORE = __webpack_require__(2), INFO = __webpack_require__(3), STRING = __webpack_require__(10), EVENTS = null, PAGE_UNLOADED = false, MIDDLEWARE = CORE.middleware("libdom.event"), IE_CUSTOM_EVENTS = {}, ERROR_OBSERVABLE_NO_SUPPORT = STRING[1131], ERROR_INVALID_TYPE = STRING[1132], ERROR_INVALID_HANDLER = STRING[1133], IE_ON = "on", IE_BUBBLE_EVENT = "beforeupdate", IE_NO_BUBBLE_EVENT = "propertychange", EXPORTS = module.exports = {
                on: listen,
                un: unlisten,
                fire: dispatch,
                purge: purge,
        ...
        "use strict";
        var CORE = __webpack_require__(2), FORMAT = __webpack_require__(15), COLOR_RE = /^(\#?|rgba?|hsla?)(\(([^\,]+(\,[^\,]+){2,3})\)|[a-f0-9]{3}|[a-f0-9]{6})$/, NUMBER_RE = /^[0-9]*\.?[0-9]+|[0-9]+\.?[0-9]*$/, REMOVE_SPACES = /[ \r\n\t\s]+/g, TO_COLOR = {
            rgb: __webpack_require__(16),
        ...
        "use strict";
        var RGBA = __webpack_require__(17), CORE = __webpack_require__(2), EXPORTS = module.exports = CORE.assign({}, RGBA);
        ...
        "use strict";
        var CORE = __webpack_require__(2), FORMAT = __webpack_require__(15), BYTE = 255, BYTE_PERCENT = 127, BYTE_HUE = 511, PERCENT = 100, HUE = 360, SATURATION = PERCENT, LUMINOSITY = PERCENT;
        ...
        "use strict";
        var HSLA = __webpack_require__(18), CORE = __webpack_require__(2), EXPORTS = module.exports = CORE.assign({}, HSLA);
        function toString(integer) {
        ...
        "use strict";
        var CORE = __webpack_require__(2), FORMAT = __webpack_require__(15), BYTE = 255, BYTE_PERCENT = 127, BYTE_HUE = 511, HUE = 360, PERCENT = 100;
        function itemize(value, index, format) {
        ...
        "use strict";
        var STRING = __webpack_require__(10), CORE = __webpack_require__(2), EASING = __webpack_require__(24), COLOR = __webpack_require__(14), CSS = __webpack_require__(13), DIMENSION = __webpack_require__(21), SESSION_ACCESS = "__animate_session", BOX_POSITION = {
            left: 0,
            top: 1,
            right: 2,
            bottom: 3,
